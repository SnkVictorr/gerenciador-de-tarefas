        ...
        <div className="h-screen w-screen p-6 relative">
            ...
            <div className="w-[500px] mx-auto space-y-4 relative z-10">
                <div className="flex justify-center relative mb-5">
                    ...
                    <h1 className="Créditos text-lg text-green-500">Créditos</h1>
                </div>

                <div className="bg-slate-200 bg-opacity-40 p-4 rounded-md relative z-10">
                    <h2 className="text-xl font-bold text-green-500">Nome: {title}</h2>
                    <p className="text-green-500 text-xl">Créditos: {description}</p>
                </div>
            </div>
        </div>
    );
